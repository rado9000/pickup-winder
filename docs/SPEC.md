...
## Połączenia (Arduino UNO / Nano) – wariant legacy
...
### TMC2208/TMC2209 (Step/Dir)
| TMC2208/TMC2209 | Arduino |
| --- | --- |
...
## Połączenia (RP2040 / Raspberry Pi Pico) – główny wariant
...
- Zakresy: 1–99999 zwojów oraz 1–2000 RPM (limit w kodzie `MAX_RPM_USER`, ustawione pod RP2040).
...
- Dla sterowania przez UART z biblioteką **TMCStepper** ustaw `USE_TMC2209_UART = 1` oraz `USE_TMC2208_UART = 1` gdy używasz TMC2208 (lub `0` dla TMC2209). Dopasuj prąd silnika, mikrokrok i `R_SENSE` w `setupTmc2209Uart()`.
